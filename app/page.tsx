...
function generateExcursionMessage(e: Excursion): string {
  ...
  const msgs: Record<ExcursionType, string[]> = {
    sea: [
      ...
      "• головной убор 🧢",
      "• очки от солнца 🕶️",
      "• коралловые тапочки / аквашузы — берегут ноги от острых кораллов и морских ежей 🪸",
      "• немного наличных для личных расходов",
      "• зарядку для телефона — будет что снимать! 📸",
      "• страховка",
      "• фото паспортов",
      "",
      "🪸 Про кораллки: на снорклинге дно каменистое, встречаются кораллы и морские ежи — коралловые тапочки очень выручают. Если своих нет, их недорого можно купить в любом магазине у моря.",
      "",
    ...
    land: [
      ...
      "• заранее закажите на ресепшене lunch box",
      "• страховка",
      "• фото паспортов",
      "",
      "Если транспорт задерживается:",
