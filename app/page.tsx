...
function generateExcursionMessage(e: Excursion): string {
  ...
  const hotline = ["", "Если транспорт задерживается, обратитесь на горячую линию:", "📞 +66922790990 (WhatsApp, Telegram)", "📞 +66922494949 (звонки с тайских номеров / с ресепшена отеля)"]
  const hotline2 = ["", "Если транспорт задерживается:", "📞 +66922790990 (WhatsApp, Telegram)", "📞 +66922494949 (звонки с тайских номеров / с ресепшена отеля)"]
...
export default function Page() {
  ...
  const [tab,setTab]=useState<"trпорт задерживается, обратитесь на горячую линию:
📞 +66922790990 (WhatsApp, Telegram)
📞 +66922494949 (звонки с тайских номеров / с ресепшена отеля)
